...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Tiens Talara v1.5.3 - Sistema de Gestión</title>  <!-- PWA Meta Tags -->
...
<body>
    ...
    <div class="main-container">
      ...
      <div class="header-section">
        ...
        <p class="subtitle">Sistema de Gestión Integral</p>
                                                            <span class="badge bg-success">v1.5.3</span>
      </div>
  ...
  <script>
      ...
      window.addEventListener('load', function() {
        navigator.serviceWorker.register('sw.js')
          .then(function(registration) {
            console.log('✅ Tiens Talara v1.5.3 - Service Worker registrado:', registration.scope);
          })
    ...
    console.log('%c🌿 Tiens Talara v1.5.3', 'color: #28a745; font-size: 16px; font-weight: bold;');
    console.log('Sistema de Gestión - PWA v1.5.3 con Registrar Compra Modernizado');
  ...
  <div class="version-indicator">v1.5.3</div>
</body>
</html>