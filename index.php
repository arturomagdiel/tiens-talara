...
<head>
  ...
  <title>Tiens Talara v1.3.4 - Sistema de Gestión</title>
...
<body>
  <div class="container">
    <div class="main-container">
      ...
      <div class="header-section">
        ...
        <span class="badge version-badge">v1.3.4</span>
      </div>
  ...
  <script>
      ...
      window.addEventListener('load', function() {
        navigator.serviceWorker.register('sw.js')
          .then(function(registration) {
            console.log('✅ Tiens Talara v1.3.4 - Service Worker registrado:', registration.scope);
          })
    ...
    console.log('%c🌿 Tiens Talara v1.3.4', 'color: #28a745; font-size: 16px; font-weight: bold;');
    console.log('Sistema de Gestión - PWA Actualizada con Login Dedicado');
  ...
  <div class="version-indicator">v1.3.4</div>
</body>
</html>