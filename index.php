...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Tiens Talara v1.4.9 - Sistema de Gestión</title>  <!-- PWA Meta Tags -->
    ...
    <div class="main-container">
      ...
      <div class="header-section">
        ...
        <p class="subtitle">Sistema de Gestión Integral</p>
                                                            <span class="badge bg-success">v1.4.9</span>
      </div>
      ...
      window.addEventListener('load', function() {
        navigator.serviceWorker.register('sw.js')
          .then(function(registration) {
            console.log('✅ Tiens Talara v1.4.9 - Service Worker registrado:', registration.scope);
          })
