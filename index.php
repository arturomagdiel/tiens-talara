...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Tiens Talara v1.4.2 - Sistema de Gestión</title>  <!-- PWA Meta Tags -->
...
<body>
  <div class="container">
    <div class="main-container">
      ...
      <div class="header-section">
        ...
        <span class="badge version-badge">v1.4.2</span>
      </div>
  ...
  <script>
      ...
      window.addEventListener('load', function() {
        navigator.serviceWorker.register('sw.js')
          .then(function(registration) {
            console.log('✅ Tiens Talara v1.4.2 - Service Worker registrado:', registration.scope);
          })
    ...
    console.log('%c🌿 Tiens Talara v1.4.2', 'color: #28a745; font-size: 16px; font-weight: bold;');
    console.log('Sistema de Gestión - PWA v1.4.2 con Vista Móvil Ultra-Simplificada');
  ...
  <div class="version-indicator">v1.4.2</div>
</body>
</html>