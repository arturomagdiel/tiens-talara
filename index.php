...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Tiens Talara v1.4.3 - Sistema de Gestión</title>  <!-- PWA Meta Tags -->
...
<body>
  <div class="container">
    <div class="main-container">
      ...
      <div class="header-section">
        ...
        <span class="badge version-badge">v1.4.3</span>
      </div>
      ...
      window.addEventListener('load', function() {
        navigator.serviceWorker.register('sw.js')
          .then(function(registration) {
            console.log('✅ Tiens Talara v1.4.3 - Service Worker registrado:', registration.scope);
          })
  ...
  <div class="version-indicator">v1.4.3</div>
</body>
</html>